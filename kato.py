...
def mover_carro(tecla_ganadora, user_id):
    global car_x, car_y
    if tecla_ganadora == "A" and car_x > 0:
        car_x -= grid_size
    elif tecla_ganadora == "D" and car_x < 660:
        car_x += grid_size
    elif tecla_ganadora == "W" and car_y > 0:
        car_y -= grid_size
    elif tecla_ganadora == "S" and car_y < 700:
        car_y += grid_size
    
    # Asegúrate de que user_id esté definido aquí
...
def juego(user_id, id_jugador, tecla_ganadora_orden):
    ...
    while running:
        ...
        # Llamar a visualizar_juego cada cierto tiempo
        if tiempo_total % 40 == 0:  # Ajusta el intervalo según sea necesario
            visualizar_juego()
                    ...
                    try:
                        with connection.cursor() as cursor:
                            ...
                            if result:
                                ...
                                mover_carro(tecla_ganadora, user_id)
                            else:
